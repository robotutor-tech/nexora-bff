import { AuthenticateAccountSchema } from './authenticateAccountSchema'

describe('AuthLoginSchema', () => {
  const valid = { email: 'alice@example.com', password: 'Password1' }

  it('should pass for a valid payload', () => {
    const result = AuthenticateAccountSchema.safeParse(valid)
  ...
  it('should fail when email is invalid', () => {
    ...
    const result = AuthenticateAccountSchema.safeParse(data)
